...
winners:
  -
    ...
    -
      -
        - 'Texas Instruments'
        - 'Kai Jiang, Rain Jiang, Botao Yuan'
      -
        - 'Yet another TAMAM (tamam)'
        - 'Ahmed Osman, Mina Gayed, Tarek Zaki, Moez Abozeid'
      -
        - 'List of Teams : (xivlo)'
        - 'Adam Gasienica-Samek, Jerzy Olkowski'
      -
        - 'Edocsmaet'
        - 'Brian Law, Andy Chen, Rithwik Gupta'
      -
        - ' (╯°□°)╯︵ ┻━┻  (maplesyrup)'
        - 'Nathan Katov, Joshua Wang, Austin Jiang, Tony Zhu'
  -
    - 'Novice division'
    -
      -
        - 'r2rx'
        - 'William Guo, Zixuan Ye, Pinmo Yu, Vedesh Ray Peddoddi'
      -
        - 'camburu'
        - 'Buruiana Rares Andrei, Tomita Matei Alexandru, Maftei Tudor, Stoleriu Radu Ionut'
      -
        - 'Lob City (chris paul)' 
        - 'Erkhem Ganzorig, Orgil Tsogtsaikhan, Tulga Erdenebayar'
      -
        - 'eoi - nullptr'
        - 'Omar Gameel, Ahmed Sameh Abdelnaby Aboelseoud Hassan, Ahmed Asaad Fathallah, Mostafa Mohammed'
      -
        - 'DP Demons (dp=dmv)'
        - 'Brian Tay, Arush Bodla, Taha Rawjani, Matthew Li'
cf_gym_novice: 'https://codeforces.com/gym/106042'
cf_gym_advanced: 'https://codeforces.com/gym/106043'
editorial: 'https://codeforces.com/blog/entry/145688'
---
